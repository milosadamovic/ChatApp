...
public class UtilMain {
    ...
    public static  void setViewPager(TabLayout tabLayout, ViewPager2 viewPager, FragmentManager fragmentManager, Lifecycle lifecycle)
    {
        ...
        Adapter adapter = new Adapter(fragmentManager, lifecycle);
